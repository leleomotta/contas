    ...
    @else
        @switch(config('adminlte.laravel_asset_bundling', false))
            ...
            @default
                ...
                <link rel="stylesheet" href="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/overlayscrollbars/2.10.1/styles/overlayscrollbars.min.css') }}">
                <link rel="stylesheet" href="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/admin-lte/3.2.0/css/adminlte.min.css') }}">
                {{--
                     vendor/fontawesome-free/css/allNOVO.min.css
    ...
    @else
        @switch(config('adminlte.laravel_asset_bundling', false))
            ...
            @default
                ...
                <script src="{{ asset('https://cdnjs.cloudflare.com/ajax/libs/admin-lte/3.2.0/js/adminlte.min.js') }}"></script>
            {{--
